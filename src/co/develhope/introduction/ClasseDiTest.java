...
public class ClasseDiTest {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String myName = "Riccardo";
        String mySurname= " Giacalone";
        String myNameAndSurname= myName + mySurname;
        System.out.println("Hello i'm " + "" + myNameAndSurname.toUpperCase());
        System.out.println("Hello i'm " + ""+ myNameAndSurname.toLowerCase());
    ...
    private static void exercise4() {
        ...
        String result = earlyNumbers.replaceAll(" ", "") + middleNumbers.replaceAll(" ", "") + endNumbers.replaceAll(" ", "");
